...
console.log(`Nuevo valor de globalBasePrice: ${globalBasePrice}`);
console.log(`Nuevo finalPrice para car1: ${car1.finalPrice}`);
console.log(`Nuevo finalPrice para car2: ${car2.finalPrice}`);